...
namespace thl {
  ...
  private:
    ...
    StrNum _sn;
    int _nerr={0};
    int _verb={1};        // verbose level
    bool _null_field={0}; // flag to take null-field
    bool _dlm_as_str={0}; // flag to take delimiter as string
    char _quot={0};       // quotation to skip split (default '\0' not skip)
  public:
    StrSplit() {}
